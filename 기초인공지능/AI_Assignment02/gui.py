...
BACKGROUND_COLOR = formatColor(0,51.0/255.0,102.0/255.0)

WALL_COLOR = formatColor(0.0/255.0, 255.0/255.0, 255.0/255.0)
...
GHOST_COLORS.append(formatColor(135/255.0,206/255.0,235/255.0)) # Yellow
GHOST_COLORS.append(formatColor(255/255.0,20/255.0,147/255.0))
...
class PacmanGraphics:
  ...
  def make_window(self, width, height):
    ...
    begin_graphics(screen_width,
                   screen_height,
                   BACKGROUND_COLOR,
                   "2022 Fall CSE4185 Assignment02")
